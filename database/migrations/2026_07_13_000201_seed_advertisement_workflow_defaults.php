...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('advertisement_workflow_transitions', 'description')) {
            Schema::table('advertisement_workflow_transitions', function ($table) {
        ...
        $transitions = [
            ...
            ['key' => 'archive_from_rejected', 'name' => 'Archive From Rejected', 'from_state' => 'Rejected', 'to_state' => 'Archived', 'role_required' => 'Admin'],
            ['key' => 'archive_from_published', 'name' => 'Archive From Published', 'from_state' => 'Published', 'to_state' => 'Archived', 'role_required' => 'Admin'],
